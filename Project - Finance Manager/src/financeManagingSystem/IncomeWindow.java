...
public class IncomeWindow implements ActionListener {
	...
	public IncomeWindow() {
		jfrm=new JFrame(" FinBud : INCOME MANAGER ");
		...
		String categoryList[]= {"Income", "Salary", "Equities", "Personal Savings", "Rents adn Royalties", "Home Equity", "Part-time Work" , "Pensions", "Annuities", "Social Security", "Account Transfer"};
	...
	jb_save.addActionListener(new ActionListener() {
		...
		try {
			...
			String query="INSERT INTO Income_Record(amount,payer,category,payment_method,payment_status,payment_description)values("+amount+",'"+payer+"','"+category+"','"+payment+"','"+payStatus+"','"+desc+"')";
